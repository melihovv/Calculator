...
/**
 ** \file parser.tab.hh
 ** Define the melihovv::calculator::parser class.
 */
...
#line 40 "parser.yy" // lalr1.cc:377
...
#line 77 "parser.tab.hh" // lalr1.cc:377
...
#line 34 "parser.yy" // lalr1.cc:377
namespace melihovv { namespace calculator {
#line 154 "parser.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const double v, const location_type& l);
    ...
    static inline
    symbol_type
    make_MULTIPLICATION (const location_type& l);
    ...
    Parser (melihovv::calculator::Lexer& lexer_yyarg, melihovv::calculator::Driver& driver_yyarg);
    virtual ~Parser ();
  ...
  private:
    ...
    // User arguments.
    melihovv::calculator::Lexer& lexer;
  ...
  Parser::symbol_type
  Parser::make_MULTIPLICATION (const location_type& l)
  {
    return symbol_type (token::MULTIPLICATION, l);
  }

  Parser::symbol_type
  Parser::make_DIVISION (const location_type& l)
  {
    return symbol_type (token::DIVISION, l);
  }

  Parser::symbol_type
  Parser::make_POWER (const location_type& l)
  {
    return symbol_type (token::POWER, l);
  }

  Parser::symbol_type
  Parser::make_LEFT_PAREN (const location_type& l)
  {
    return symbol_type (token::LEFT_PAREN, l);
  }

  Parser::symbol_type
  Parser::make_RIGHT_PAREN (const location_type& l)
  {
...
#line 1026 "parser.tab.hh" // lalr1.cc:377
